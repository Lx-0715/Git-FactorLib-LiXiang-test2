...
config_custom = {
    ...
    # #                  }],
    "factor_dict": [
                    # {"func_name_factor": "JunCang_signal",
                    #  "param_dataSrc": [
                    #      {"func_name_dataSrc": "query_DB",
                    #       "colName_dataSrc": ['close', {'date': 'trade_date'}],
                    ...
                    {"func_name_factor": "BSM_signal",
                     "param_dataSrc": [
                         {"func_name_dataSrc": "BSM_g.dataTrade.pkl",
                          "colName_dataSrc": [{'date': 'trade_date'}, 'close', 'high', 'low', 'open', {'volume': 'vol'}],
                          "security": '000300.XSHG', "data_usage_purpose": 'signal'},
                         {"func_name_dataSrc": "BSM_g.dataTrade.pkl",
                          "colName_dataSrc": [{'date': 'trade_date'}, 'close'],
                          "security": '000300.XSHG', "data_usage_purpose": 'trade'},
                     ],
                     "param_factor": {},
                     "file_name_model": "factor_BSM",
                     },]
